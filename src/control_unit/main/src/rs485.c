...
#define log_event_button(TAG, pwm_index, pwm_enabled, pwm_duty, device_id, button_id, button_state) \
	ESP_LOGI( \
...
#define log_event_trimmer(TAG, pwm_index, pwm_enabled, pwm_duty, device_id, trimmer_val) \
	ESP_LOGI( \
...
// !!! FARE DUE FUNZIONI PRIVATE PER IL SETUP DEL DRIVER ED IL SETUP DEL TASK
