 ...
 * @return `true` if at least `ms` milliseconds have passed. `false` if the delay was explicitly interrupted by returning `false` from the `background_routine()` or there are some parameter errors.
